...
//
//  Created by Ace River Rapport on 2025/3/12.
//
...
- (void)rapportShowAlertWithTitle:(NSString *)title message:(NSString *)message {
...
- (void)rapportAddChildController:(UIViewController *)child toContainerView:(UIView *)container {
...
- (void)rapportRemoveFromParentController {
...
{
    id adsView = [self.storyboard instantiateViewControllerWithIdentifier:@"RapportPolicyViewController"];
